            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Overview')" class="grid">
                    ...
                    @if(auth()->user() && auth()->user()->role === 'admin')
                        <flux:navlist.item icon="cpu-chip" :href="route('ai-assistant')" :current="request()->routeIs('ai-assistant')" wire:navigate>{{ __('Ask AI Assistant') }}</flux:navlist.item>
                    @endif
                </flux:navlist.group>

                <flux:navlist.group :heading="__('Transactions')" expandable class="grid">
                    ...
                    <flux:navlist.item icon="credit-card" :href="route('payment-vouchers.index')" :current="request()->routeIs('payment-vouchers.*')" wire:navigate>{{ __('Payment Vouchers') }}</flux:navlist.item>
                ...
                <flux:navlist.group :heading="__('Accounting')" expandable class="grid">
                ...
                <flux:navlist.group :heading="__('Financial Reports')" expandable class="grid">
                    ...
                    <flux:navlist.item icon="banknotes" :href="route('cashbook.index')" :current="request()->routeIs('cashbook.*')" wire:navigate>{{ __('Cashbook') }}</flux:navlist.item>
                ...
                <flux:navlist.group :heading="__('Analysis Reports')" expandable class="grid">
                ...
                <flux:navlist.group :heading="__('Operations')" expandable class="grid">
                    <flux:navlist.item icon="computer-desktop" :href="route('assets.index')" :current="request()->routeIs('assets.*')" wire:navigate>{{ __('Assets') }}</flux:navlist.item>
                    ...
                    @if(auth()->user() && auth()->user()->role === 'admin')
                        <flux:navlist.item icon="user-circle" :href="route('staff.index')" :current="request()->routeIs('staff.*')" wire:navigate>{{ __('Staff') }}</flux:navlist.item>
                        <flux:navlist.item icon="currency-dollar" :href="route('payroll.index')" :current="request()->routeIs('payroll.*')" wire:navigate>{{ __('Payroll') }}</flux:navlist.item>
                    @endif
                </flux:navlist.group>
