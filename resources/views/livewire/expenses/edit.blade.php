...
new class extends Component {
    ...
    public function mount(int $id): void
    {
        ...
        $this->payment_reference = $expense->payment_reference ?: '';
    ...
    public function updateExpense(): void
    {
        ...
        // Update payment_date if status changed to paid (and no date yet)
        if ($this->payment_status === 'paid' && !$expense->payment_date) {
