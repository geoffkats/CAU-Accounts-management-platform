...
new class extends Component {
    ...
    public function mount(Vendor $vendor): void
    {
        ...
        $this->payment_method = $vendor->payment_method ?? '';
        ...
        $this->mobile_money_provider = $vendor->mobile_money_provider ?? '';
        $this->mobile_money_number = $vendor->mobile_money_number ?? '';
        $this->business_type = $vendor->business_type ?? '';
        $this->currency = $vendor->currency ?? 'UGX';
        $this->ussd_provider = $vendor->ussd_provider ?? '';
        $this->ussd_number = $vendor->ussd_number ?? '';
    }
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Update vendor information</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="bg-gradient-to-r from-purple-500 to-indigo-600 px-6 py-6">
            ...
            <p class="text-purple-100 mt-1 text-sm">Update the vendor details below</p>
        </div>
