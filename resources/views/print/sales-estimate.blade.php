...
<head>
    <meta charset="utf-8">
    <title>Estimate - {{ $sale->invoice_number }}</title>
    <style>
...
<body>
        ...
        <table class="header-table">
            <tr>
                ...
                <td style="width: 20%; text-align: right; vertical-align: top;">
                    <div class="meta-box">
                        <div class="meta-row"><div class="meta-label">Estimate #</div><div class="meta-value">{{ $sale->invoice_number }}</div></div>
    ...
    <div class="section">
        ...
        <table class="items-table">
            ...
            <tbody>
                <tr>
                    <td>{{ $sale->description ?: 'Estimate summary' }}</td>
                    <td class="right">1</td>
    ...
    <div class="section notes">
        <div class="section-title">Scope & Terms</div>
        <div>{{ $sale->terms_conditions ?: 'Estimate valid for the stated period. Payment terms and delivery timeline apply as agreed.' }}</div>
    </div>

    <div class="section">
        <div class="section-title">Client Approval</div>
        <div class="approval-box">
            <div class="approval-line">Client Approval</div>
    ...
    <div class="footer">
        <p>Generated on {{ now()->format('F d, Y H:i:s') }} | Estimate #{{ $sale->invoice_number }}</p>
    </div>
</body>
</html>
