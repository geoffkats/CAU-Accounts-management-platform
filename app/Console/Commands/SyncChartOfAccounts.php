...
class SyncChartOfAccounts extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($standardAccounts as $accountData) {
            ...
            if (!$existing) {
                ...
                if ($existing->category !== ($accountData['category'] ?? null)) {
                    $needsUpdate = true;
                    $changes[] = "category: '{$existing->category}' → '{$accountData['category']}'";
                }
    ...
    private function getStandardAccounts(): array
    {
        return [
            ...
            ['code' => '1000', 'name' => 'Cash on Hand', 'type' => 'asset', 'category' => 'short_term', 'description' => 'Physical cash in office', 'is_active' => true],
            ['code' => '1100', 'name' => 'Bank Account - Main', 'type' => 'asset', 'category' => 'short_term', 'description' => 'Primary bank account', 'is_active' => true],
            ['code' => '1200', 'name' => 'Accounts Receivable', 'type' => 'asset', 'category' => 'short_term', 'description' => 'Money owed by customers/students', 'is_active' => true],
            ['code' => '1599', 'name' => 'Accumulated Depreciation', 'type' => 'asset', 'category' => 'long_term', 'description' => 'Contra-asset account for accumulated depreciation', 'is_active' => true],

            // Liabilities (2000-2999)
            ['code' => '2000', 'name' => 'Accounts Payable', 'type' => 'liability', 'category' => 'short_term', 'description' => 'Money owed to vendors', 'is_active' => true],
            ['code' => '2100', 'name' => 'Loans Payable', 'type' => 'liability', 'category' => 'long_term', 'description' => 'Outstanding loans and borrowings', 'is_active' => true],
